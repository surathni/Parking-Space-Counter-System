...
while True:
    ...
    info_frame = np.zeros((170, 680, 3), dtype=np.uint8)

    # Display Information
    cv2.putText(info_frame, f'Date and Time: {current_datetime}', (30, 30), 2, 0.8,(255, 255, 255))
    cv2.putText(info_frame, f'Total Number of Parking Lots: {total_parking_lots}', (30, 70), 2, 0.8,(255, 255, 255))
    cv2.putText(info_frame, f'Occupied Spaces: {car_count} ({occupancy_percentage:.2f}%)', (30, 110), 2, 0.8,(255, 255, 255))
    cv2.putText(info_frame, f'Free Spaces: {free_space} ({100 - occupancy_percentage:.2f}%)', (30, 150), 2, 0.8,(255, 255, 255))
